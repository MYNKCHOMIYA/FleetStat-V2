...
ALTER TABLE IF EXISTS ONLY public.truck_services DROP CONSTRAINT IF EXISTS truck_services_truck_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trips DROP CONSTRAINT IF EXISTS trips_truck_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trip_assignments DROP CONSTRAINT IF EXISTS trip_assignments_trip_id_fkey;
ALTER TABLE IF EXISTS ONLY public.trip_assignments DROP CONSTRAINT IF EXISTS trip_assignments_driver_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipments DROP CONSTRAINT IF EXISTS shipments_sender_customer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipments DROP CONSTRAINT IF EXISTS shipments_receiver_customer_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipments DROP CONSTRAINT IF EXISTS shipments_container_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipment_items DROP CONSTRAINT IF EXISTS shipment_items_shipment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.payments DROP CONSTRAINT IF EXISTS payments_shipment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.fuel_logs DROP CONSTRAINT IF EXISTS fuel_logs_truck_id_fkey;
ALTER TABLE IF EXISTS ONLY public.fuel_logs DROP CONSTRAINT IF EXISTS fuel_logs_trip_id_fkey;
ALTER TABLE IF EXISTS ONLY public.shipments DROP CONSTRAINT IF EXISTS fk_shipment_trip;
ALTER TABLE IF EXISTS ONLY public.drivers DROP CONSTRAINT IF EXISTS fk_driver_user;
ALTER TABLE IF EXISTS ONLY public.damage_reports DROP CONSTRAINT IF EXISTS damage_reports_shipment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.container_assignments DROP CONSTRAINT IF EXISTS container_assignments_trip_id_fkey;
ALTER TABLE IF EXISTS ONLY public.container_assignments DROP CONSTRAINT IF EXISTS container_assignments_container_id_fkey;
...
DROP INDEX IF EXISTS public.idx_truck_services_truck;
DROP INDEX IF EXISTS public.idx_trips_truck;
DROP INDEX IF EXISTS public.idx_trip_truck;
DROP INDEX IF EXISTS public.idx_trip_assignments_trip;
DROP INDEX IF EXISTS public.idx_trip_assignments_driver;
DROP INDEX IF EXISTS public.idx_shipments_sender;
DROP INDEX IF EXISTS public.idx_shipments_receiver;
DROP INDEX IF EXISTS public.idx_shipments_container;
DROP INDEX IF EXISTS public.idx_shipment_sender;
DROP INDEX IF EXISTS public.idx_shipment_receiver;
DROP INDEX IF EXISTS public.idx_shipment_items_shipment;
DROP INDEX IF EXISTS public.idx_payments_shipment;
DROP INDEX IF EXISTS public.idx_payment_shipment;
DROP INDEX IF EXISTS public.idx_fuel_logs_truck;
DROP INDEX IF EXISTS public.idx_fuel_logs_trip;
DROP INDEX IF EXISTS public.idx_drivers_user;
DROP INDEX IF EXISTS public.idx_damage_reports_shipment;
DROP INDEX IF EXISTS public.idx_container_assignments_trip;
DROP INDEX IF EXISTS public.idx_container_assignments_container;
DROP INDEX IF EXISTS public.idx_assignment_trip;
DROP INDEX IF EXISTS public.idx_assignment_driver;
...
ALTER TABLE IF EXISTS ONLY public.trucks DROP CONSTRAINT IF EXISTS trucks_license_plate_key;
ALTER TABLE IF EXISTS ONLY public.truck_services DROP CONSTRAINT IF EXISTS truck_services_pkey;
ALTER TABLE IF EXISTS ONLY public.trips DROP CONSTRAINT IF EXISTS trips_pkey;
ALTER TABLE IF EXISTS ONLY public.trip_assignments DROP CONSTRAINT IF EXISTS trip_assignments_pkey;
...
ALTER TABLE IF EXISTS ONLY public.drivers DROP CONSTRAINT IF EXISTS driver_pkey;
ALTER TABLE IF EXISTS ONLY public.drivers DROP CONSTRAINT IF EXISTS driver_phone_no_key;
ALTER TABLE IF EXISTS ONLY public.drivers DROP CONSTRAINT IF EXISTS driver_licence_number_key;
ALTER TABLE IF EXISTS ONLY public.drivers DROP CONSTRAINT IF EXISTS driver_email_key;
...
ALTER TABLE IF EXISTS ONLY public.containers DROP CONSTRAINT IF EXISTS containers_container_code_key;
ALTER TABLE IF EXISTS ONLY public.container_assignments DROP CONSTRAINT IF EXISTS container_assignments_pkey;
...
ALTER TABLE IF EXISTS public.trucks ALTER COLUMN truck_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.truck_services ALTER COLUMN service_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.trips ALTER COLUMN trip_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.trip_assignments ALTER COLUMN assignment_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.shipments ALTER COLUMN shipment_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.shipment_items ALTER COLUMN item_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.payments ALTER COLUMN payment_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.fuel_logs ALTER COLUMN fuel_log_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.drivers ALTER COLUMN driver_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.damage_reports ALTER COLUMN damage_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.customers ALTER COLUMN customer_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.containers ALTER COLUMN container_id DROP DEFAULT;
ALTER TABLE IF EXISTS public.container_assignments ALTER COLUMN assignment_id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.vehicles_vehicle_id_seq;
DROP TABLE IF EXISTS public.vehicles;
DROP SEQUENCE IF EXISTS public.users_user_id_seq;
DROP TABLE IF EXISTS public.users;
DROP SEQUENCE IF EXISTS public.trucks_truck_id_seq;
DROP SEQUENCE IF EXISTS public.truck_services_service_id_seq;
DROP VIEW IF EXISTS public.truck_maintenance_analytics;
DROP TABLE IF EXISTS public.truck_services;
DROP VIEW IF EXISTS public.truck_analytics;
DROP TABLE IF EXISTS public.trucks;
DROP SEQUENCE IF EXISTS public.trips_trip_id_seq;
DROP SEQUENCE IF EXISTS public.trip_assignments_assignment_id_seq;
DROP SEQUENCE IF EXISTS public.shipments_shipment_id_seq;
DROP VIEW IF EXISTS public.shipment_summary;
DROP SEQUENCE IF EXISTS public.shipment_items_item_id_seq;
...
DROP SEQUENCE IF EXISTS public.fuel_logs_fuel_log_id_seq;
DROP TABLE IF EXISTS public.fuel_logs;
DROP VIEW IF EXISTS public.driver_ranking;
DROP VIEW IF EXISTS public.driver_performance;
DROP TABLE IF EXISTS public.trips;
DROP TABLE IF EXISTS public.trip_assignments;
DROP SEQUENCE IF EXISTS public.driver_driver_id_seq;
DROP TABLE IF EXISTS public.drivers;
DROP SEQUENCE IF EXISTS public.damage_reports_damage_id_seq;
DROP TABLE IF EXISTS public.damage_reports;
DROP SEQUENCE IF EXISTS public.customers_customer_id_seq;
DROP VIEW IF EXISTS public.customer_revenue;
DROP TABLE IF EXISTS public.shipments;
DROP TABLE IF EXISTS public.payments;
DROP TABLE IF EXISTS public.customers;
DROP SEQUENCE IF EXISTS public.containers_container_id_seq;
DROP VIEW IF EXISTS public.container_utilization;
DROP TABLE IF EXISTS public.containers;
DROP SEQUENCE IF EXISTS public.container_assignments_assignment_id_seq;
DROP TABLE IF EXISTS public.container_assignments;
...
--
-- Name: container_assignments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: container_assignments_assignment_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: container_assignments_assignment_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: container_utilization; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: containers_container_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: containers_container_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: customer_revenue; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: damage_reports_damage_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: damage_reports_damage_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: driver_performance; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: driver_ranking; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: fuel_logs_fuel_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: fuel_logs_fuel_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: shipment_items_item_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: shipment_items_item_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: shipment_summary; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: trip_assignments_assignment_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: trip_assignments_assignment_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: trips_trip_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: truck_analytics; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: truck_services; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: truck_maintenance_analytics; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: truck_services_service_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: truck_services_service_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: trucks_truck_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: trucks_truck_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: container_assignments assignment_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: containers container_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: damage_reports damage_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: fuel_logs fuel_log_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: shipment_items item_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: trip_assignments assignment_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: trips trip_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: truck_services service_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: trucks truck_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: container_assignments; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: truck_services; Type: TABLE DATA; Schema: public; Owner: -
--
...
1	mayank	mayank@gmail.com	$2b$12$xisu7AaEEM5G6J.TairrgONMCzrc/v6dXSaOfdPAOrXBiOMNqf73a	admin	t	2026-06-10 09:22:25.88082	2026-06-15 06:48:58.775781
\.
...
--
-- Name: container_assignments_assignment_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: containers_container_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: damage_reports_damage_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: fuel_logs_fuel_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.payments_payment_id_seq', 42, true);


--
-- Name: shipment_items_item_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.shipments_shipment_id_seq', 23, true);


--
-- Name: trip_assignments_assignment_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: trips_trip_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: truck_services_service_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: trucks_truck_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.trucks_truck_id_seq', 23, true);
...
--
-- Name: container_assignments container_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: containers containers_container_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: drivers driver_email_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: drivers driver_licence_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: drivers driver_phone_no_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: drivers driver_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: truck_services truck_services_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trucks trucks_license_plate_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_assignment_driver; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_assignment_trip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_container_assignments_container; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_container_assignments_trip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_reports_shipment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_fuel_logs_trip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_fuel_logs_truck; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payment_shipment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_payments_shipment; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shipment_receiver; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shipment_sender; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shipments_container; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shipments_receiver; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shipments_sender; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trip_assignments_driver; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trip_assignments_trip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trip_truck; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_trips_truck; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_truck_services_truck; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: containers trg_containers_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: trucks trg_trucks_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: container_assignments container_assignments_container_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: container_assignments container_assignments_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: damage_reports damage_reports_shipment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: drivers fk_driver_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shipments fk_shipment_trip; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fuel_logs fuel_logs_truck_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: payments payments_shipment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shipments shipments_container_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shipments shipments_receiver_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shipments shipments_sender_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trip_assignments trip_assignments_trip_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: truck_services truck_services_truck_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
